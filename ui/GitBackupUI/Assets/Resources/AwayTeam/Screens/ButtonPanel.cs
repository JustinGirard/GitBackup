...
public class ButtonPanel : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (dockedButton.renderTexture != null)
        {
            rawImageInstance.texture = dockedButton.renderTexture;
        }
        else
        {
            Debug.LogWarning($"(ok on init) DockedButton {dockedButton.gameObject.name} has no RenderTexture assigned yet..");
        }
    }
    ...
    private void Update()
    {
        ...
        if (dockedButton != null && dockedButton.renderTexture != rawImageInstance.texture)
        {
            rawImageInstance.texture = dockedButton.renderTexture;
        }
