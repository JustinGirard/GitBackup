...
namespace MDPackage.ExampleContent
{
    ...
    /// </summary>
    public sealed class MD_Examples_GeometryManager : MonoBehaviour
    {
        ...
        private async void CreateNewGeo<T>() where T : MD_GeometryBase
        {
            ...
            // Wait a frame until destroy is completed properly... This can be done through the coroutines as well
