...
namespace MDPackage.ExampleContent
{
    ...
    /// </summary>
    public sealed class MD_Examples_Manager : MonoBehaviour
    {
        [Multiline(5)] public string SceneDestription;
        private static readonly Color DescColor = new Color(121f / 255f, 154f / 255f, 204f / 255f);
        ...
        private void Update()
        {
            ...
            if (Input.GetMouseButtonDown(0))
            {
                ...
                if (h.collider.GetComponent<MDM_MeshDamage>())
                    h.collider.GetComponent<MDM_MeshDamage>().MeshDamage_ModifyMesh(h.point, 0.15f, 1.0f, transform.forward, true);
            }
        }
