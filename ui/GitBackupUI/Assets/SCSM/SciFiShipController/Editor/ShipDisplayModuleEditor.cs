...
namespace SciFiShipController
{
    ...
    public class ShipDisplayModuleEditor : Editor
    {
        ...
        private readonly static GUIContent showAltitudeMetricContent = new GUIContent(" Show Altitude Metic", "Show the Altitude metric (m) on the HUD if the Altitude indicator is show. [Has no effect outside play mode]");
