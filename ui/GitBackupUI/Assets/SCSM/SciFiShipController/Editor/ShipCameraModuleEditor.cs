...
namespace SciFiShipController
{
    ...
    public class ShipCameraModuleEditor : Editor
    {
        ...
        private readonly static GUIContent orbitHeaderContent = new GUIContent("Check the manual (Help) for camera orbit input setup");
        private readonly static GUIContent isOrbitEnabledContentSCM = new GUIContent("Orbit", "Enable or disable the ability to orbit the camera around the ship");
        private readonly static GUIContent orbitDistanceContentSCM = new GUIContent("Orbit Distance", "The distance from the target ship transform position to the ship camera position");
        private readonly static GUIContent orbitHorizDampingContentSCM = new GUIContent("Horizontal Damping", "The amount of damping applied when starting or stopping horizontal camera orbit");
        private readonly static GUIContent orbitVertDampingContentSCM = new GUIContent("Vertical Damping", "The amount of damping applied when starting or stopping vertical camera orbit");
        private readonly static GUIContent orbitSpeedContentSCM = new GUIContent("Orbit Speed", "The speed or rate at which the camera orbits round the ship.");
        private readonly static GUIContent isOrbitGroundDetectionContentSCM = new GUIContent("Ground Detection", "Automatically restrict the vertical orbit if there are objects immediately beneath the ship. Currently this assumes the ground or collider under the ship is flat and can be detected directly under the position of the ship.");
        private readonly static GUIContent orbitGroundMaskContentSCM = new GUIContent("Ground Mask", "Ground detection in the selected Unity Layers.");
        private readonly static GUIContent orbitGroundDetectOffsetContentSCM = new GUIContent("Detection Offset", "The local space offset from the target ship position to begin detecting the ground. Typically, you'll want to use a negative Y value for ships with multiple colliders.");
