...
namespace SciFiShipController
{
    ...
    public class ProjectileModule : MonoBehaviour
    {
        ...
        protected void ProcessHitInfo()
        {
            ...
            if (shieldEffectsObjectPrefabID >= 0 && CheckShipHit(hitInfo, damageAmount, damageType, sourceShipId, sourceSquadronId, projectilePrefabID, shieldPenetration, out shipControlModule))
            {
            ...
            else if (shieldEffectsObjectPrefabID < 0 && CheckShipHit(hitInfo, damageAmount, damageType, sourceShipId, sourceSquadronId, projectilePrefabID, shieldPenetration))
            {
        ...
        public static bool CheckShipHit (RaycastHit raycastHitInfo, float projectileDamageAmount, DamageType projectileDamageType, 
            int sourceShipId, int sourceShipSquadronId, int projectilePrefabID, float shieldPenetration)
        {
            bool isHit = false;
        ...
        /// <returns></returns>
        public static bool CheckShipHit (RaycastHit raycastHitInfo, float projectileDamageAmount, DamageType projectileDamageType, 
            int sourceShipId, int sourceShipSquadronId, int projectilePrefabID, float shieldPenetration, out ShipControlModule shipControlModule)
        {
            bool isHit = false;
            Rigidbody hitRigidbody = raycastHitInfo.rigidbody;
